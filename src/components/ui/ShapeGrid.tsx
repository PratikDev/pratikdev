...
interface ShapeGridProps {
	...
	vignetteStopColor?: CanvasStrokeStyle;
}
...
const ShapeGrid: React.FC<ShapeGridProps> = ({
	...
	vignetteStopColor = "rgba(0, 0, 0, 0)",
}) => {
	...
	useEffect(() => {
		...
		const drawGrid = () => {
			...
			gradient.addColorStop(0, vignetteStopColor as string);
			gradient.addColorStop(1, vignetteColor as string);
