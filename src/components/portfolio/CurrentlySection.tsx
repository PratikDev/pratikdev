			...
			<Reveal className="site-card">
				{mode === "frontend" ? (
					<div className="flex gap-4">
						<div className="flex size-10 shrink-0 items-center justify-center rounded-[var(--site-radius-control)] bg-primary text-primary-foreground">
							<Activity className="size-5" aria-hidden="true" />
						</div>
						<p className="text-base leading-[var(--site-leading)] text-card-foreground">
